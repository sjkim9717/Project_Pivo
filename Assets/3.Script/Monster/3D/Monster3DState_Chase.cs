...
public class Monster3DState_Chase : IMonsterStateBase {
    ...
    public Monster3DState_Chase(Camera camera, NavMeshAgent navMesh, GameObject monster, Transform player3d, Vector3 originPos, float radius) {
    ...
    public void EnterState(MonsterControl MControl) {
        ...
        MonsterManager.instance.Ani3D.SetBool("IsMove", true);
    }
    ...
    public void ExitState(MonsterControl MControl) {
        ...
        MonsterManager.instance.Ani3D.SetBool("IsMove", false);
    }
