...
public class AnimationState_Climb : StateMachineBehaviour {
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        if (obstacle3DCheck != null && player3DController.IsClimb) {
            ...
            //Vector3 climbPosition = obstacle3DCheck.ClimbObstacle.transform.position;
            //Vector3 playerToMove = new Vector3(climbPosition.x, climbPosition.y + 1, climbPosition.z);
            //player3D.transform.position = playerToMove;
